...
Practice **filename expansion** with `*`, `?`, and `[...]` (globbing).

**Layout**: `a.txt`, `b.txt`, `c.txt`, `report_2024.txt`, `report_2023.txt`, `data_1.log`, `data_2.log`, `design.v`.
...
See `wildcards/README.md` for *, ?, and [...] patterns and RTL-style usage.

---

## 8. Touch (`touch/`)

Practice **creating empty files** and **updating timestamps** with `touch`.

**Layout**: `existing.txt` (file to update), README.
